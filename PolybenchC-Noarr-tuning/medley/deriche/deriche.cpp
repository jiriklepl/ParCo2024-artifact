...
struct tuning {
	NOARR_TUNE_BEGIN(MAKE_OPENTUNER_FORMATTER("deriche"));

	NOARR_TUNE_PAR(img_in_layout, noarr::tuning::choice, h_vec ^ w_vec, w_vec ^ h_vec);
	NOARR_TUNE_PAR(img_out_layout, noarr::tuning::choice, h_vec ^ w_vec, w_vec ^ h_vec);

	NOARR_TUNE_PAR(y1_layout, noarr::tuning::choice, h_vec ^ w_vec, w_vec ^ h_vec);
	NOARR_TUNE_PAR(y2_layout, noarr::tuning::choice, h_vec ^ w_vec, w_vec ^ h_vec);
