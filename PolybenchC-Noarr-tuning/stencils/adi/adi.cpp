...
struct tuning {
	NOARR_TUNE_BEGIN(MAKE_OPENTUNER_FORMATTER("adi"));

	NOARR_TUNE_PAR(u_layout, noarr::tuning::choice, j_vec ^ i_vec, i_vec ^ j_vec);
	NOARR_TUNE_PAR(v_layout, noarr::tuning::choice, i_vec ^ j_vec, j_vec ^ i_vec);
	NOARR_TUNE_PAR(p_layout, noarr::tuning::choice, j_vec ^ i_vec, i_vec ^ j_vec);
	NOARR_TUNE_PAR(q_layout, noarr::tuning::choice, j_vec ^ i_vec, i_vec ^ j_vec);
